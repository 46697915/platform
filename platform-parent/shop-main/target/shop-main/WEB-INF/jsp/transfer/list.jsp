	...
	//编辑用户信息
 	function editTransfer(){
	 	...
	 	if (row){
		 	...
		 	$('#fm').form('load',row);
		 	url = path+"/transfer/modify?id="+id;
		 	mesTitle = '编辑成功';
	 	}else{
	...
	//删除用信息
 	function deleteTransfer(){
	 	...
	 	if (row){
		 	...
		 	$('#fm').form('load',row);
		 	url = path+"/transfer/delete?id="+id;
		 	mesTitle = '删除成功';
	 	}else{
...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		...
		<table id="datagrid" class="easyui-datagrid" 
			...
			<thead>
				<tr>
					<th field="jzrq" width="100">结转日期</th>
		...
		<div id="toolbar">
			...
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" onclick="addTransfer();">新增</a> 
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-edit" plain="true" onclick="editTransfer();">编辑</a> 
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true" onclick="deleteTransfer();">删除</a>
			<span>用户名:</span><input name="search_username" id="search_username" value="" size=10 /> 
  			<a href="javascript:searchTransferQ()" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a> 
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-jright" plain="true" onclick="searchTransfer();">更多查询</a>
		</div>
		...
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" method="post" novalidate>
				...
				<div class="fitem">
					<label>结转日期:</label> <input name="jzrq" class="easyui-textbox" required="true">
				</div>
				<div class="fitem">
		...
		<div id="dlg-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="saveTransfer()" style="width:90px">保存</a> 
				<a href="javascript:void(0)" class="easyui-linkbutton"
		...
		<div id="dlg-del-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="saveTransfer_del()" style="width:90px">删除</a> 
			<a href="javascript:void(0)" class="easyui-linkbutton"
		...
		<div id="dlg-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="searchTransfer()" style="width:90px">查询</a> 
				<a href="javascript:void(0)" class="easyui-linkbutton"
