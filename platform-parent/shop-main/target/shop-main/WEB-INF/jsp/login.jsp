...
<div style="width:100%;height:90%;position: absolute;top:50%;left:50%;margin-top:-320px;margin-left:-50%;">
	...
	<div class="center">
		<div class="login_right">
			...
			<!--
				<input type="text" name="openid" id="openid" class="login_input" value="${openid }"/> ${loginname } -->
				...
				<div class="login_info">
					<label>验证码：</label>
					<input type="text" name="code" id="code" class="login_input" value=""/>
		...
		<div class="login_left">
			<div style="width:100%;height:auto;margin-top:150px;">
				...
				<!-- <div >&nbsp;</div> -->
				<div class="left_txt">
				<font color="blue" size="12">药店管理系统</font>
				</div>
			</div>
		</div>
	</div>
