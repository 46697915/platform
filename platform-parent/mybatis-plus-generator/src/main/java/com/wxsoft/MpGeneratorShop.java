 ...
 * </p>
 */
public class MpGeneratorShop {

    //代码输出路径
//    private static String outputDir = "E:/IdeaProjects/shop/shop-parent/mybatis-plus-generator/src/main/java";
    private static String outputDir = "E:/IdeaProjects/platform/platform-parent/shop-statistics/src/main/java";
    //生成 类的  父包名
    private static String parentPackage = "com.wxsoft.business";
    //数据库地址
...
//        assert (false) : "代码生成属于危险操作，请确定配置后取消断言执行代码生成！";
        ...
        gc.setBaseColumnList(true);//生成默认列
