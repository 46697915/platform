...
public class StorecheckJz {
	...
	public String getInitstore() {
		return initstore;
	}
	public void setInitstore(String initstore) {
	...
	public void setInstoreamount(String instoreamount) {
	...
	public String getCrrcheckdate() {
		return crrcheckdate;
	}
	public void setCrrcheckdate(String crrcheckdate) {
