...
<script type="text/javascript">
    ...
    <body class="easyui-layout">  
        <!-- 正上方panel -->  
        <div data-options="region:'north',border:false" style="height:60px;background:#46B43B;padding:0px;overflow-y:hidden">
        <!-- <div class="main_header" region="north" style="height:70px;padding:5px;" > -->
			<!--<div class="header_left"></div> -->
			<div>&nbsp;
			</div>
			<div style="font-size:20px;">
				<strong><SPAN style="color: blue;font-size:40px;">药&nbsp;店&nbsp;管&nbsp;理&nbsp;系&nbsp;统</SPAN></strong>
			</div>
        ...
        <div region="south" style="height:24px;line-height:22px;" align="center">  
            <label style="font-size:11px;">SHOP-V5.0&nbsp;&nbsp;&nbsp;[&nbsp;yun_shop@aliyun.com&nbsp;]</label>  
        </div>
    </body>
</html>
