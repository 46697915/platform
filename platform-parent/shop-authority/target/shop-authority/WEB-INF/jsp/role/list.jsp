...
<script type="text/javascript">
	...
	/*    var row = $('#datagrid').datagrid('getSelected');
	   ...
	   $.messager.alert('提示', '请选择要编删除的记录！', 'error');
	   		return ;
	   }
	   $.messager.confirm("提示","确认删除?",function(r){
	      if(r){
	         $.post("${pageContext.request.contextPath }/role/deleteRole.do",{"roleID":roleID},function(){
...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		...
		<div id="toolbar">
			...
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" onclick="add();">新增角色</a> 
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-edit" plain="true" onclick="edit();">编辑角色</a> 
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true" onclick="dtl();">删除角色</a>
		</div>
		...
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" method="post" novalidate>
				...
				<div class="fitem">
					<label>名称:</label> <input name="rolename" class="easyui-textbox" required="true">
				</div>
				<!-- <div class="fitem">
					<label>资源地址:</label> <input name="menu" class="easyui-textbox" required="true">
				</div> -->
			</form>
		</div>
