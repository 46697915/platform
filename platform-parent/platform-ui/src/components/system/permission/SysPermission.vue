    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                pageNO: 1,
                //列表数据
                listurl: '/permissions/listForPage',
                addurl: '/permissions/add',
                editurl: '/permissions/edit',
                deleteurl: '/permissions/deleteBatch',
                loading: true,
                listData: [],
                multipleSelection: [],
                tableHeader: [
                    {prop: 'id', label: 'id', minWidth: '100px',isHidden: true},
                    {prop: 'description', label: '名称', minWidth: '100px'},
                    {prop: 'url', label: '地址', minWidth: '100px'},
                    {prop: 'type', label: '类型', minWidth: '100px'},
                    {prop: 'path', label: '路径', minWidth: '100px'},
                    {prop: 'parentid', label: '父id', minWidth: '100px'},
                    {prop: 'icon', label: '图标', minWidth: '100px'},
                    {prop: 'enabled', label: '是否可用', minWidth: '100px'
                        , formatData: this.codeTransf.isNo
                    },
        ...
        methods: {
            ...
            //删除按钮
            deleteHandle(row){
                this.$confirm('此操作将永久删除[' + row.description + '], 是否继续?', '提示', {
            ...
            deleteManyRows(){
                ...
                this.$confirm(
                    '此操作将永久删除[' + this.multipleSelection[0].description + '等'+this.multipleSelection.length+'条记录], 是否继续?', '提示', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
