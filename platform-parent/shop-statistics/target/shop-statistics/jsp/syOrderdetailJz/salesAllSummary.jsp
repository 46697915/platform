...
<script type="text/javascript">
	...
	//快速查询
 	function searchsyOrderdetailJzQ(){
	    var options = $('#datagrid').datagrid('options');
	    options.url = __path + '/syOrderdetailJz/salesAllSummaryData';
	    /**
	    options.queryParams = {
 	...
 	function exportExcel(){
 		var method = __path + '/syOrderdetailJz/exportAllExcel?barcode_search='+$('#barcode_search').combobox('getValue')+
 			'&createdate_begin='+$('#search_begin').datebox('getValue')+
 			'&createdate_end='+$('#search_end').datebox('getValue');
	...
	//查询
 	function searchsyOrderdetailJz(){
...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		<!-- 信息列表 title="管理" -->
			<!-- url="${__path}/syOrderdetailJz/salesAllSummaryData"  -->
		...
		<div id="toolbar">
			...
			<%--<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" onclick="addsyOrderdetailJz();">新增</a>
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-edit" plain="true" onclick="editsyOrderdetailJz();">编辑</a>
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true" onclick="deletesyOrderdetailJz();">删除</a>
			--%><a href="javascript:void(0);" class="easyui-linkbutton"
			...
			<%--<span>订单编号:</span><input name="ordercode" id="ordercode" value="" size=10 /> --%>
  			<a href="javascript:searchsyOrderdetailJzQ()" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a>
			<a href="javascript:exportExcel()" class="easyui-linkbutton" data-options="iconCls:'icon-search'">导出</a> 
			<%--<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-jright" plain="true" onclick="searchsyOrderdetailJz();">更多查询</a>
		--%></div>
</form>
		<!-- 查询对话框 -->
		...
		<div id="dlg-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="searchsyOrderdetailJz()" style="width:90px">查询</a>
				<a href="javascript:void(0)" class="easyui-linkbutton"
