...
<script type="text/javascript">
	...
	//快速查询
 	function searchInstorageQ(){
	    ...
	    options.url = __path + '/syInstorageJz/instorageSummaryData';
	 	$("#datagrid").datagrid("load", {
	 		"barcode_search": $('#search_barcode').combobox('getValue'),
	 		"signtype": $('#signtype_search').combobox('getValue'),
	...
	function cleanSearch(){
		...
		$('#signtype_search').combobox('setValue','');
...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		<!-- 信息列表 title="管理" -->
		<!-- url="${path}/syInstorageJz/instorageSummaryData"  -->
		<table id="datagrid" class="easyui-datagrid" 
			...
			<thead>
				<tr>
					...
					<th field="barcode2" width="100">条形码</th>
				</tr>
			</thead>
		</table>
<form id="ff" method="post" >
		...
		<div id="toolbar"style="padding:5px;height:auto">
			...
			<span>入库日期:</span>
			<input id="search_begin" class="easyui-datebox" size=15  >
			至
			<input id="search_end" class="easyui-datebox" size=15  >
			<span>标记类型:	</span> <input id="signtype_search" name="signtype" size=7 class="easyui-combobox">
  			<a href="javascript:searchInstorageQ()" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a> 
			<a href="javascript:exportExcel()" class="easyui-linkbutton" data-options="iconCls:'icon-man'">导出</a>
			<!--<a href="javascript:void(0);" class="easyui-linkbutton"
